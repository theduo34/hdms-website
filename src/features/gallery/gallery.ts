...
// Mirrors the storage path sub-folders under media/gallery/ and media/videos/
export type PhotoSub = 'all' | 'events' | 'student-activities' | 'campus' | 'staff'
export type VideoSub = 'all' | 'events' | 'culture' | 'tour'
...
export const dummyPhotos: GalleryPhoto[] = [
    // events — storage: gallery/events/{year}/
    ...
    // student-activities — storage: gallery/student-activities/{year}/
    { id: 'p7',  type: 'photos', subCategory: 'student-activities', src: cl('c_fill,ar_4:3,w_1000', 'home1_dw0ei5'),                  alt: 'Students in hands-on Montessori activity',   title: 'Hands-On Learning in Action',          createdAt: '2025-01-06', width: 1000, height: 750  },
    { id: 'p8',  type: 'photos', subCategory: 'student-activities', src: cl('c_fill,ar_2:3,w_700',  'home1_dw0ei5'),                  alt: 'Child focused on Montessori materials',      title: 'The Power of Focus',                   createdAt: '2025-01-06', width: 700,  height: 1050 },
    { id: 'p9',  type: 'photos', subCategory: 'student-activities', src: cl('c_fill,ar_16:9,w_1200','home5_iaxp6n'),                  alt: 'Year 6 group lesson with teacher',           title: 'Guided Discovery – Year 6',            createdAt: '2025-04-22', width: 1200, height: 675  },
    { id: 'p10', type: 'photos', subCategory: 'student-activities', src: cl('c_fill,ar_3:4,w_800',  'home5_iaxp6n'),                  alt: 'Student reading independently',              title: 'Independent Reading Hour',             createdAt: '2025-04-22', width: 800,  height: 1067 },
    { id: 'p11', type: 'photos', subCategory: 'student-activities', src: cl('c_fill,ar_3:2,w_1200', 'home6_nogd8s'),                  alt: 'Inter-House Sports Day 2025',                title: 'Inter-House Sports Day 2025',          createdAt: '2025-02-22', width: 1200, height: 800  },
    { id: 'p12', type: 'photos', subCategory: 'student-activities', src: cl('c_fill,ar_2:3,w_700',  'home6_nogd8s'),                  alt: 'Athlete racing at HDM Sports Day',           title: 'Green House Takes the Lead',           createdAt: '2025-02-22', width: 700,  height: 1050 },
    { id: 'p13', type: 'photos', subCategory: 'student-activities', src: cl('c_fill,ar_16:9,w_1200','home6_nogd8s'),                  alt: 'Relay race at HDM Sports Competition',       title: 'The Relay',                            createdAt: '2025-02-22', width: 1200, height: 675  },
    // campus — storage: gallery/campus/ (no year — buildings change rarely)
    ...
    // staff — storage: gallery/staff/{year}/
    ...
    { id: 'p20', type: 'photos', subCategory: 'student-activities', src: cl('c_fill,ar_1:1,w_900',  'home1_dw0ei5'),                  alt: 'Montessori prepared classroom environment',  title: 'The Prepared Environment',             createdAt: '2026-01-06', width: 900,  height: 900  },
]

export const dummyVideos: GalleryVideo[] = [
    // events — storage: videos/events/{year}/
    { id: 'v1', type: 'videos', subCategory: 'events',  thumbnail: cl('c_fill,ar_16:9,w_1200', 'speech_and_prize_giving_dg4atw'), alt: 'Speech Day highlights reel',    title: 'Speech & Prize Giving Day – Full Highlights',       createdAt: '2025-11-28', duration: '4:32',  videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', width: 1200, height: 675 },
    { id: 'v2', type: 'videos', subCategory: 'events',  thumbnail: cl('c_fill,ar_16:9,w_1200', 'Career_Day_bdnpcu'),             alt: 'Career Day video recap',         title: 'Career Day 2025 – Student Reactions',               createdAt: '2025-10-14', duration: '2:55',  videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', width: 1200, height: 675 },
    { id: 'v3', type: 'videos', subCategory: 'events',  thumbnail: cl('c_fill,ar_16:9,w_1200', 'home6_nogd8s'),                 alt: 'Sports Day highlights video',    title: 'Inter-House Sports Day 2025 – Highlights',          createdAt: '2025-02-22', duration: '3:18',  videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', width: 1200, height: 675 },
    { id: 'v4', type: 'videos', subCategory: 'events',  thumbnail: cl('c_fill,ar_16:9,w_1200', 'IMG-20250502-WA0106_svmbvh'),  alt: 'Open Day tour video',            title: 'HDM Open Day – Campus Virtual Tour',                createdAt: '2025-01-11', duration: '8:20',  videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', width: 1200, height: 675 },
    // culture — storage: videos/culture/{year}/
    { id: 'v5', type: 'videos', subCategory: 'culture', thumbnail: cl('c_fill,ar_16:9,w_1200', 'IMG_8049_wz9imc'),              alt: 'Christmas Carols performance',   title: 'Christmas Carols Service 2025 – Full Recording',    createdAt: '2025-12-19', duration: '22:10', videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', width: 1200, height: 675 },
    { id: 'v6', type: 'videos', subCategory: 'culture', thumbnail: cl('c_fill,ar_16:9,w_1200', 'home5_iaxp6n'),                 alt: 'Morning assembly at HDM',        title: "A Morning at Heaven's Dew – Assembly Walk-through", createdAt: '2025-01-06', duration: '6:45',  videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', width: 1200, height: 675 },
    // tour — storage: videos/tour/ (static, no year)
    { id: 'v7', type: 'videos', subCategory: 'tour',    thumbnail: cl('c_fill,ar_16:9,w_1200', 'home1_dw0ei5'),                 alt: 'Classroom learning video',       title: 'Inside the Montessori Classroom – Year 4',          createdAt: '2025-04-22', duration: '5:00',  videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', width: 1200, height: 675 },
    { id: 'v8', type: 'videos', subCategory: 'tour',    thumbnail: cl('c_fill,ar_16:9,w_1200', 'school_building_ftvs0v'),       alt: 'HDM year in review video',       title: 'HDM Year in Review – 2025',                         createdAt: '2025-12-31', duration: '12:05', videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', width: 1200, height: 675 },
]
...
// Slugs match storage path segments exactly: media/gallery/{slug}/ and media/videos/{slug}/
