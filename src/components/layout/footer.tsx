        ...
        >
            ...
            >
                <div className="max-w-7xl mx-auto w-full flex flex-col justify-between">
                    ...
                    {/* Top Section: Logo, Contact, Quicklinks */}
                    <div
                        className="flex flex-col md:flex-row justify-between md:justify-around gap-16 md:gap-8 mb-16 px-4 md:px-0">
                        ...
                        <div
                            className="flex flex-col md:flex-row justify-between md:justify-around w-full gap-16 md:gap-8">
                            <motion.div
                                initial={{ opacity: 0, y: 24 }}
                                animate={isInView ? { opacity: 1, y: 0 } : {}}
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-1.5 text-sm text-primary-foreground/90 font-medium">
                                    ...
                                    <p>Koforidua, E/R</p>
                                    <p>Ghana</p>
                                    <a href="tel:(508)653-4312" className="mt-4 hover:opacity-75 transition-opacity">
                                        +233 24 497 4052
                                    </a>
                                </div>
                            </motion.div>
                    ...
                    <div
                        className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-primary-foreground/10">
                        <motion.div
                            initial={{ opacity: 0 }}
                        ...
                        >
                            <p className="text-[10px] md:text-[11px] text-primary-foreground/60">
                                © {new Date().getFullYear()} HDM Heaven&apos;s Dew Montessori. All rights reserved.
                            </p>
                        </motion.div>
                    </div>
                </div>
