...
export const metadata: Metadata = {
    ...
    description: "See Heaven's Dew Montessori for yourself. Schedule a campus visit and experience our nurturing learning environment in Koforidua, Ghana firsthand.",
    openGraph: {
        title: "Visit Our Campus",
        description: "Words can only say so much. Come visit our campus in Koforidua and see why families across the Eastern Region choose Heaven's Dew Montessori.",
